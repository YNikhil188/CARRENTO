...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2025 at 02:37 AM
...
INSERT INTO `bookings` (`booking_id`, `car_id`, `customer_name`, `email`, `phone`, `start_date`, `end_date`, `total_price`, `booking_date`, `model`, `returned_date`, `return_location`, `latitude`, `longitude`, `status`) VALUES
(26, 24, 'nikhil', 'nikhil@gmail.com', '8985902404', '2025-01-02', '2025-01-04', 1500.00, '2025-01-02 04:41:11', 'Hyundai Verna', '2025-01-05', 'chennai', 13.01751420, 80.01784890, 'pending'),
(29, 25, 'nikhil', 'nikhil@gmail.com', '6301856894', '2025-01-05', '2025-01-07', 1700.00, '2025-01-05 09:35:07', 'Honda City', NULL, NULL, NULL, NULL, 'pending'),
(30, 26, 'madhan', 'madhan@gmail.com', '8985902404', '2025-01-08', '2025-01-10', 1900.00, '2025-01-08 03:43:23', 'Volkswagen Virtus', NULL, NULL, NULL, NULL, 'pending'),
(31, 31, 'singh', 'singh@gmail.com', '8985902404', '2025-01-09', '2025-01-11', 4000.00, '2025-01-09 09:17:58', 'Mahindra Thar', NULL, NULL, NULL, NULL, 'pending'),
(32, 28, 'singh', 'singh@gmail.com', '8985902404', '2025-01-12', '2025-01-14', 7500.00, '2025-01-12 08:58:47', 'Toyoto Fortuner', NULL, NULL, NULL, NULL, 'pending');
...
CREATE TABLE `cars` (
  ...
  `status` enum('Available','Rented','In Maintenance') NOT NULL DEFAULT 'Available'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(25, 'Honda City.jpeg', 'Honda City', 850.00, 'Automatic', 'Petrol', 4, '1', 5, 19.076, 72.8777, 'Available'),
...
INSERT INTO `payment` (`id`, `userid`, `transaction_id`, `total_price`, `product_id`, `paid_on`) VALUES
(24, 1, 'pay_PeRkVtENNLh1cS', 1500, '24', '2025-01-02 04:41:45'),
(27, 1, 'pay_PfiMSk5VQcLYvv', 1700, '25', '2025-01-05 09:35:40'),
(28, 86, 'pay_Pgnye6nQtIiEmN', 1900, '26', '2025-01-08 03:44:34'),
(29, 87, 'pay_PhIE2c4xCJYu4s', 4000, '31', '2025-01-09 09:19:50'),
(30, 87, 'pay_PiTTjabnji4cLt', 7500, '28', '2025-01-12 08:59:18');
...
(1, 'nikhil', 'nikhil@gmail.com', '123456', '2', '9392510416', '2024-11-13', 'male', 'Permanent', '521228', 'chennai', '12354484216581', 'uploads/license/Screenshot 2024-10-22 135004.png', '2024-11-13 03:42:39', '123456789012', 'uploads/aadhaar/licence.jpg'),
(2, 'admin', 'admin@gmail.com', '1234', '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-11-13 04:01:17', '', NULL),
(4, 'employee', 'employee@gmail.com', '1234', '3', '6677889900', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-12-03 17:04:33', '', NULL),
