    ...
    <style>
        ...
        * {
        ...
        .contact-info .map-container {
            margin: 20px; /* Increased from 10px to 20px for more vertical spacing */
        }
        ...
        .contact-card p {
            margin-top: 45px; /* Adds space below each paragraph */
        }

        /* Add this new rule here */
        .contact-card .admin-btn {
        ...
        .contact-card .admin-btn:hover {
            background-color: #26a69a; /* Teal on hover */
        ...
        <div class="contact-us-container">
            ...
            <div class="contact-info">
                <div class="contact-card">
                    ...
                    <a href="chat_user.php" class="admin-btn">Message with Admin</a>
                </div>
